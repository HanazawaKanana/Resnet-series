...
def resnext50_32x4d(num_classes=1000, include_top=True, pretrained=False):
    ...
    if pretrained==True:
        model.load_state_dict(model_zoo.load_url(model_urls['resnext50_32x4d']), strict=False)
    return model


def resnext101_32x8d(num_classes=1000, include_top=True, pretrained=False):
    ...
    model=ResNet(Bottleneck, [3, 4, 23, 3],
                  ...
                  width_per_group=width_per_group)
    if pretrained==True:
        model.load_state_dict(model_zoo.load_url(model_urls['resnext101_32x8d']),strict=False)
    return model