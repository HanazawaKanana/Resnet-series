...
parser.add_argument('--net',default='resnet18',type=str,choices=['resnet18','resnet34','resnet101','resnet152','resnext50_32x4d','resnext101_32x8d'])
...
def main(args):
    ...
    if args.net=='resnet18':
        ...
        net = resnext50_32x4d(pretrained=args.pretrained)
    else:
    ...
    epochs = 3
    best_acc = 0.0
    save_path = './{}.pth'.format(args.net)##模型权重的保存路径
